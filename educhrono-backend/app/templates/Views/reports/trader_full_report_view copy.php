...
<div id="report-container" class="max-w-6xl mx-auto p-4 sm:p-10 bg-white shadow-2xl rounded-3xl my-8">
  ...
  <div class="rounded-2xl p-6 shadow-lg bg-emerald-50 border-l-4 border-emerald-500 leading-relaxed  page-break avoid-break">
    <h3 class="text-xl font-bold text-emerald-700 mb-3 flex items-center gap-2">
  ...
  <!-- Next Steps -->
  <div class="rounded-2xl p-6 shadow-lg bg-green-50 border-l-4 border-green-500 leading-relaxed  page-break avoid-break">
